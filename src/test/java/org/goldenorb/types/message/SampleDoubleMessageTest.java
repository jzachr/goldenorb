...
public class SampleDoubleMessageTest {
  public final static double MESSAGE_VALUE = 1.0d;
  public final static String DESTINATION_VALUE = "Destination!";
  public final static int SERVER_PORT = 13000;
  
  private RPCProtocol<DoubleMessage,DoubleWritable> client;
  private RPCServer<DoubleMessage,DoubleWritable> server;
  
  private DoubleMessage dm0 = new DoubleMessage();
 ...
 */
  ...
  public void startServer() throws IOException {
    ...
    if (client == null) client = (RPCProtocol<DoubleMessage,DoubleWritable>) RPC.waitForProxy(
      RPCProtocol.class, RPCProtocol.versionID, addr, conf);
  }
  
  @Test
  public void testRPC() {
    DoubleMessage dm1 = client.sendAndReceiveMessage(dm0, DESTINATION_VALUE, new DoubleWritable(
        MESSAGE_VALUE));
