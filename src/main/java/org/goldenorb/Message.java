...
/** 
 * A Writable for the messages that will be sent between vertices. You must
 * subclass this class, and include the the type in the constructor of the
 * subclass if you wish to be able to use it in hadoop rpc.
 *
 * For example:
 * <code>
